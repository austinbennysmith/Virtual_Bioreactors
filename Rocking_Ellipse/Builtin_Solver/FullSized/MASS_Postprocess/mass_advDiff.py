...
mass_total = np.genfromtxt("FullSized_diffusionh/mass.dat")
mass_IN = np.genfromtxt("FullSized_diffusionh/mass_IN.dat")
mass_OUT = np.genfromtxt("FullSized_diffusionh/mass_OUT.dat")
mass_water = np.genfromtxt("FullSized_diffusionh/mass_water.dat")
mass_air = np.genfromtxt("FullSized_diffusionh/mass_air.dat")
# print(mass_total)
# print("hello world")
...
plt.savefig('tracer_masses_advDiff.png')
plt.show()